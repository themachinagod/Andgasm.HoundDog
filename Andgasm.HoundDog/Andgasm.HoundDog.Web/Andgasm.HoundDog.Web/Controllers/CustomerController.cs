...
using DAL;
using Andgasm.HoundDog.Web.ViewModels;
using AutoMapper;
using Microsoft.Extensions.Logging;
using Andgasm.HoundDog.Web.Helpers;

namespace Andgasm.HoundDog.Web.Controllers
{
    ...
    public class CustomerController : ControllerBase
    {
        ...
        public async Task<string> Email()
        {
            ...
            (bool success, string errorMsg) = await _emailSender.SendEmailAsync(recepientName, recepientEmail, "Test Email from Andgasm.HoundDog.Web", message);
