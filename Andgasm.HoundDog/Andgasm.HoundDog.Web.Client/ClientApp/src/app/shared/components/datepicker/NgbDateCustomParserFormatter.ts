...
export class NgbDateCustomParserFormatter extends NgbDateParserFormatter {
  ...
  format(date: any): string {
    ...
    var localeKey = this._localeService.getUsersLocale("en-GB");
    var localFormatStr = this.getLocaleDateString();
    return formatDate(d, localFormatStr, localeKey);
  }

  // move to utility class
  // todo: long formatting
  getLocaleDateString() {
